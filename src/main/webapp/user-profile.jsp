...
<main>
    ...
    <div id="homeUser">
        ...
        <section>
            <input type="button" value="View Ships" onclick="httpGet('register-ship.jsp');"><br>
            <input type="button" value="View Bank Account"><br>
            <input type="button" value="View Licenses"><br>
            <input type="button" value="View Jobs"><br>
            <input type="button" value="View Order History"><br>
        </section>
    </div>
